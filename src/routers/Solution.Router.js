...
import { addViewsToSolution, alterLikesToSolution, getDetailsOfSolution, getSolutions, uploadSolution } from "../controllers/Solution.controller.js";

const router = Router();

router.post('/upload-solution',authenticationToken, uploadSolution);
router.get('/get-solutions', authenticationToken, getSolutions);
router.put('/add-views-to-solution',authenticationToken,addViewsToSolution);
